...
namespace CloudBall.Engines.LostKeysUnited
{
	...
	public struct Position : IPoint, ISerializable
	{
		...
		public static implicit operator Position(Common.Vector vector) { return new Position(vector.X, vector.Y); }
		
		/// <summary>Casts the <see cref="CloudBall.Engines.LostKeysUnited.Positionr"/> to a <see cref="Common.Vector"/>.</summary>
		public static implicit operator Common.Vector(Position position) { return new Common.Vector(position.X, position.Y); }
